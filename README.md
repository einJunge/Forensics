...
permite el examen de directorios y archivos dentro de la imagen. Los directorios dentro de la imagen se 
...
enumeran de forma predeterminada en el área de vista principal
